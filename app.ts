...
let big_number:bigint=7696989686969n;
...
let arr:number[]=[23,45,778,96,4446,9];

let arr2=[2,1,168,5];

let arr3=["uygyuyi",7,75,"gi",4];

let arr4:(string | number)[]=["uygyuyi",765,7,"gi",4];

arr3.push(true);
arr3.push(67);

let arr5:(string | number | boolean)[]=["yugyu",899,false,"ughuig",76,true,34];

// tuple :- specially mention everyone

let tuple:[string,number,number,boolean,string]=["ihiuui",54676,767868,true,"ghiu"];
...
//   using interface is better than type
